...
//         setJobs(data.results); // ← Now TypeScript knows about results
//       } catch (err) {
...
//                 const responsibilitiesArray = textToArray(job.responsibilities);
//                 const requirementsArray = textToArray(job.qualifications);
//                 const skillsArray = getSkillsArray(job.required_skills);
//                 const preferredSkillsArray = getSkillsArray(
...
//                       }
//                       className="w-full p-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4 text-left hover:bg-gray-50 transition-colors"
//                     >
...
//                         <span className="text-sm font-medium text-[#6D28D9] flex items-center gap-1">
//                           {expandedJob === job.id
//                             ? "Hide Details"
//                             : "View Details"}
//                           {expandedJob === job.id ? (
...
//                                 <span
//                                   key={i}
//                                   className="px-3 py-1 bg-[#6D28D9]/10 text-[#6D28D9] rounded-full text-sm font-medium"
//                                 >
//                                   {skill}
//                                 </span>
//                               ))}
...
//                                 >
//                                   <span className="text-[#6D28D9] mt-1.5 flex-shrink-0">
//                                     •
//                                   </span>
//                                   <span>{resp}</span>
//                                 </li>
...
//                             </h4>
//                             <div className="flex flex-wrap gap-2">
//                               {preferredSkillsArray.map((skill, i) => (
//                                 <span
//                                   key={i}
//                                   className="px-3 py-1 bg-[#8B5CF6]/10 text-[#8B5CF6] rounded-full text-sm font-medium"
//                                 >
//                                   {skill}
//                                 </span>
//                               ))}
...
//                               className="flex-1 sm:flex-none inline-flex items-center justify-center gap-2 px-8 py-3 bg-gradient-to-r from-[#6D28D9] to-[#8B5CF6] text-white rounded-lg font-semibold hover:shadow-lg hover:scale-105 transition-all"
//                             >
//                               Apply Now
//                               <ArrowRight className="w-5 h-5" />
//                             </a>
//                           ) : (
//                             <a
//                               href={`mailto:${job.application_email}?subject=Application for ${job.title}&body=Hi, I would like to apply for the ${job.title} position.`}
//                               className="flex-1 sm:flex-none inline-flex items-center justify-center gap-2 px-8 py-3 bg-gradient-to-r from-[#6D28D9] to-[#8B5CF6] text-white rounded-lg font-semibold hover:shadow-lg hover:scale-105 transition-all"
//                             >
//                               Apply via Email
//                               <ArrowRight className="w-5 h-5" />
...
//                             }}
//                             className="flex-1 sm:flex-none inline-flex items-center justify-center gap-2 px-8 py-3 bg-white text-gray-700 rounded-lg font-semibold border-2 border-gray-200 hover:border-[#6D28D9] transition-all"
//                           >
//                             Share Job
//                           </button>
//                         </div>
          ...
          >
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="border-t pt-6 mt-8">
                ...
                <a
                  href={`mailto:hr@growthifyservices.in?subject=Application for ${selectedJob.title}&body=Hi Hiring Team,%0D%0A%0D%0AI am interested in the ${selectedJob.title} position.%0D%0A%0D%0APlease find my resume attached.%0D%0A%0D%0AThank you,%0D%0A[Your Name]`}
