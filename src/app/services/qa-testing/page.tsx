...
const features = [
  {
    ...
    desc: "Thorough manual testing by experienced QA professionals.",
  },
  {
    icon: Zap,
    title: "Automated Testing",
    desc: "Selenium, Cypress, and Playwright automation frameworks.",
  },
  {
    icon: Gauge,
    title: "Performance Testing",
    desc: "Load testing and performance optimization with JMeter and K6.",
  },
  {
    icon: Shield,
  ...
  },
  {
    ...
    desc: "Cross-device and cross-platform mobile app testing.",
  },
  {
    icon: Bug,
    title: "Bug Tracking",
    desc: "Comprehensive bug reporting and tracking workflows.",
  },
];
const tools = [
  // 🔹 Automation Testing
  {
    name: "Selenium",
    icon: "/icons/qa/selenium.svg",
    desc: "Industry-standard automation testing framework for web applications across multiple browsers and platforms.",
  },
  {
    name: "Cypress",
    icon: "/icons/qa/cypress.svg",
    desc: "Modern end-to-end testing framework built for fast, reliable, and developer-friendly UI testing.",
  },

  // 🔹 Mobile App Testing
  {
    name: "BrowserStack",
    icon: "/icons/qa/browserstack.svg",
    desc: "Cloud-based platform for testing mobile and web applications on real devices and browsers globally.",
  },
  {
    name: "Appium",
    icon: "/icons/qa/appium.svg",
    desc: "Open-source mobile automation framework for native, hybrid, and mobile web applications.",
  },
  {
    name: "Firebase Test Lab",
    icon: "/icons/qa/firebase.svg",
    desc: "Google-powered testing infrastructure for running automated and robo tests on real Android and iOS devices.",
  },

  // 🔹 API Testing
  {
    name: "Postman",
    icon: "/icons/qa/postman.svg",
    desc: "Popular API testing and collaboration platform used for validating REST APIs with ease.",
  },

  // 🔹 Performance Testing
  {
    name: "JMeter",
    icon: "/icons/qa/apachejmeter.svg",
    desc: "Apache JMeter is used for load and performance testing to ensure system reliability under heavy traffic.",
  },
];
      ...
      <section className="bg-[#F9FAFB] py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
          ...
          <p className="text-[#6B7280] text-lg text-center max-w-2xl mx-auto mb-12 sm:mb-16">
            End-to-end quality assurance for flawless software delivery.
          </p>
        ...
        <div className="bg-gradient-to-br from-[#1a1a1a] via-[#2d2d2d] to-[#1a1a1a] rounded-3xl p-8 sm:p-12 lg:p-16 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-6">
              ...
              <span className="text-white">Market Ready</span>
            </h3>
            <p className="text-gray-400 text-base sm:text-lg mb-8 sm:mb-10 max-w-2xl mx-auto">
              From unit tests to full-scale load testing — we make sure your
              product is bulletproof before it reaches your users.
            </p>
