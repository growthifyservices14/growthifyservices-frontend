...
const features = [
  {
    ...
    desc: "Large-scale software systems designed for complex business operations.",
  },
  {
    icon: Puzzle,
    title: "API Development",
    desc: "RESTful and GraphQL APIs for seamless system integrations.",
  },
  {
    icon: Cog,
    title: "System Integration",
    desc: "Connect disparate systems for unified data flow and operations.",
  },
  {
    icon: RefreshCw,
    title: "Legacy Modernization",
    desc: "Upgrade outdated systems to modern, scalable architectures.",
  },
  {
    icon: Cloud,
    title: "Cloud Solutions",
    desc: "AWS, Azure, and GCP implementations for scalable infrastructure.",
  },
  {
    icon: Code2,
    title: "Microservices",
    desc: "Modular architecture for flexibility and independent scaling.",
  },
];
const tools = [
  {
    ...
    desc: "In-depth analysis of business requirements to design custom software solutions that align perfectly with goals, workflows, and user expectations.",
  },
  {
    name: "Custom Development",
    icon: "/icons/custom/development.png",
    desc: "Tailor-made software development using modern technologies to build scalable, secure, and high-performance applications.",
  },
  {
    name: "Integration & APIs",
    icon: "/icons/custom/integration.png",
    desc: "Seamless integration with third-party services, APIs, and existing systems to ensure smooth data flow and extended functionality.",
  },
  {
    name: "Scalable Architecture",
    icon: "/icons/custom/scalable.png",
    desc: "Future-ready system architecture designed to scale effortlessly as your business grows, ensuring long-term flexibility and performance.",
  },
];
      ...
      <section className="bg-[#F9FAFB] py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
          ...
          <p className="text-[#6B7280] text-lg text-center max-w-2xl mx-auto mb-12 sm:mb-16">
            End-to-end custom software development for your business needs.
          </p>
        ...
        <div className="bg-gradient-to-br from-[#1a1a1a] via-[#2d2d2d] to-[#1a1a1a] rounded-3xl p-8 sm:p-12 lg:p-16 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-6">
              ...
              <span className="text-white">That Fits</span>
            </h3>
            <p className="text-gray-400 text-base sm:text-lg mb-8 sm:mb-10 max-w-2xl mx-auto">
              From architecture to deployment — we craft custom software
              tailored to your unique challenges and built to scale with your
              business.
            </p>
